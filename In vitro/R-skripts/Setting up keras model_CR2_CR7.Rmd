...
Train_CR2 <- read.csv("Train_CR2.csv")
Train_CR7 <- read.csv("Train_CR7.csv")

Val_CR2 <- read.csv("Val_CR2.csv")
Val_CR7 <- read.csv("Val_CR7.csv")

Test_CR2 <- read.csv("Test_CR2.csv")
Test_CR7 <- read.csv("Test_CR7.csv")
```
...
all_train <- rbind(Train_CR2,Train_CR7)
all_val <- rbind(Val_CR2,Val_CR7)
all_test <- rbind(Test_CR2,Test_CR7)
...
save_model_hdf5(model,"Distinguish CR2vCR7 clones with feature values_in_vitro.h5")
```
